...
class ProofOfResidenceFragment : Fragment(),
    ...
    private val viewModel: ProofOfResidenceViewModel by lazy {
        ViewModelProvider(this).get(ProofOfResidenceViewModel::class.java)
    }
        ...
        when (effect) {
            ...
            is ProofOfResidenceContract.Effect.GoToProofUpload ->
                findNavController().navigate(
                    ProofOfResidenceFragmentDirections.actionToProofUpload()
                )
        }
    }
}